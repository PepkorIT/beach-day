...
var RequestRunner = (function () {
    ...
    RequestRunner.run = function (call, env) {
        ...
        if (!requestPassed) {
            ...
            var currSpecId = BeachDayReporter_2.ReporterAPI.getCurrentSpecId();
            RequestRunner.request(options, function (error, res, body) {
                ...
                try {
                    ...
                    if (currSpecId != BeachDayReporter_2.ReporterAPI.getCurrentSpecId()) {
     ...
     */
    RequestRunner.logRequestResponse = function (error, res, parsedResponseBody, options, isError) {
        /*
        {
            "statusCode": 200,
            "body": "",
