...
var project_paths_1 = require("../utils/project-paths");
// Non typescript dependencies
var moment = require('moment');
var stringifyObject = require('stringify-object');
var ReporterConfig = /** @class */ (function () {
    function ReporterConfig(config) {
        ...
        this.headerTemplatePath = config.headerTemplatePath ? config.headerTemplatePath : path.resolve(project_paths_1.ProjectPaths.templates, 'header.mustache');
        this.indexTemplatePath = config.indexTemplatePath ? config.indexTemplatePath : path.resolve(project_paths_1.ProjectPaths.templates, 'index.mustache');
        this.suiteTemplatePath = config.suiteTemplatePath ? config.suiteTemplatePath : path.resolve(project_paths_1.ProjectPaths.templates, 'suite.mustache');
        this.stylesPath = config.stylesPath ? config.stylesPath : path.resolve(project_paths_1.ProjectPaths.templates, 'styles.scss');
        this.titleTemplatePath = config.titleTemplatePath ? config.titleTemplatePath : path.resolve(project_paths_1.ProjectPaths.templates, 'title.mustache');
        this.summaryTemplatePath = config.summaryTemplatePath ? config.summaryTemplatePath : path.resolve(project_paths_1.ProjectPaths.templates, 'summary.mustache');
        this.latestTemplatePath = config.latestTemplatePath ? config.latestTemplatePath : path.resolve(project_paths_1.ProjectPaths.templates, 'latest.mustache');
...
exports.consoleOrig = global.console;
...
var ReporterConsole = /** @class */ (function () {
    ...
    ReporterConsole.prototype.store = function (args, logger) {
        ...
        if (this.logToConsole) {
            logger.apply(exports.consoleOrig, args);
        }
    };
...
function stringLogArguments(args) {
    var newArgs = [];
...
exports.ReporterAPI = {
     ...
     */
    overrideSpecMaxTestTime: function (value) {
     ...
     */
    getReporterConfig: function () {
        return lastCreatedInstance.config;
    }
};
var BeachDayReporter = /** @class */ (function () {
    function BeachDayReporter(config) {
        if (lastCreatedInstance)
            throw new Error('You can only create 1 instance of the BeachDayReporter at a time');
    ...
    Object.defineProperty(BeachDayReporter.prototype, "currentSpecId", {
        get: function () {
    ...
    BeachDayReporter.prototype.overrideSpecMaxTestTime = function (value) {
        if (this.currentSpec) {
    ...
    BeachDayReporter.prototype.wrap = function (cb) {
        try {
            ...
            exports.consoleOrig.log(e.stack);
        }
    };
    /*
    Jasmine methods
    ...
    */
    ...
    BeachDayReporter.prototype.jasmineDone = function (result) {
        ...
        this.wrap(function () {
            ...
            report_generator_1.generate(_this.dataStore, _this.config);
    ...
    BeachDayReporter.prototype.recurseSuitesPopulateViewData = function (data, level) {
        ...
        data.viewChildren.forEach(function (specOrSuite) {
            ...
            if (!specOrSuite.isSpec) {
                ...
                else if (_this.config.maxTestTime != null) {
                    maxTestTime = _this.config.maxTestTime;
                }
