...
export class ReporterConfig implements IReporterConfig {
    ...
    constructor(config:IReporterConfig = {}) {
        ...
        this.headerTemplatePath    = config.headerTemplatePath ? config.headerTemplatePath : path.resolve(ProjectPaths.templates, 'header.mustache');
        this.indexTemplatePath     = config.indexTemplatePath ? config.indexTemplatePath : path.resolve(ProjectPaths.templates, 'index.mustache');
        this.suiteTemplatePath     = config.suiteTemplatePath ? config.suiteTemplatePath : path.resolve(ProjectPaths.templates, 'suite.mustache');
        this.stylesPath            = config.stylesPath ? config.stylesPath : path.resolve(ProjectPaths.templates, 'styles.scss');
        this.titleTemplatePath     = config.titleTemplatePath ? config.titleTemplatePath : path.resolve(ProjectPaths.templates, 'title.mustache');
        this.summaryTemplatePath   = config.summaryTemplatePath ? config.summaryTemplatePath : path.resolve(ProjectPaths.templates, 'summary.mustache');
        this.latestTemplatePath    = config.latestTemplatePath ? config.latestTemplatePath : path.resolve(ProjectPaths.templates, 'latest.mustache');
