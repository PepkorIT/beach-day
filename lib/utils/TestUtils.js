...
exports.TestUtils = {
    ...
    validateSwaggerSchema: function (data, swaggerObject, endPoint, method, isResponse, statusCode) {
        var valid = false;
        var schema;
    ...
    validateSchema: function (data, schema, isResponse) {
        var _this = this;
        ...
        if (!result.valid) {
            ...
            BeachDayReporter_1.console.log((isResponse ? "Response" : "Request") + " Schema Failure Result:");
