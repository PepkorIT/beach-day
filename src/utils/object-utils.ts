export class ObjectUtils {
    ...
    public static setProp(target:any, propertyAccessor:string, value:any):any {
        if (target == null) throw new Error('target must be populated');
        ...
        for (var i = 0; i < parts.length; i++) {
            ...
            if (part.indexOf('[') != -1) {
                ...
                if (varName != '') {
                    ...
                    if (!currObject.hasOwnProperty(varName) || currObject[varName] == null) currObject[varName] = [];
                    currObject = currObject[varName];
                }
            ...
            // Error handler, should have array selector in the part if the source is an array
                ...
                if (!currObject.hasOwnProperty(part) || currObject[part] == null) currObject[part] = {};
